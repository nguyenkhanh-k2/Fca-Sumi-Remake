...
<a href="https://www.npmjs.com/package/@sumibot/fca-unofficial"><img alt="npm version" src="https://img.shields.io/npm/v/@sumibot/fca-unofficial.svg?style=flat-square"></a>
<a href="https://www.npmjs.com/package/@sumibot/fca-unofficial"><img src="https://img.shields.io/npm/dm/@sumibot/fca-unofficial.svg?style=flat-square" alt="npm downloads"></a>
...
## Install
If you just want to use @sumibot/fca-unofficial, you should use this command:
```bash
npm install @sumibot/fca-unofficial
```
It will download @sumibot/fca-unofficial from NPM repositories
...
## Example Usage
```javascript
const login = require("@sumibot/fca-unofficial");

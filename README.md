...
```bash
npm i fca-sumi-remake
```
or
```bash
npm install fca-sumi-remake
```
...
```bash
npm install fca-sumi-remake@latest
```
Hoặc
```bash
npm i fca-sumi-remake@latest
```
...
```javascript
const login = require("fca-sumi-remake"); // lấy từ lib ra 
...
```js
    var login = require('fca-sumi-remake')
```
...
```js
const fs = require("fs");
const login = require("fca-sumi-remake");
